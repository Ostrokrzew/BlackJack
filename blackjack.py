#Blackjack
#Od 1 do 7 graczy i rozdający
#Należy mieć wynik 21 pkt (natychmiastowa wygrana) lub jak najbliższy tej liczbie
#Przekroczenie 21 pkt powoduje przegraną

import karty, gry     

class BJ_Card(karty.Card):
    """ Karta do blackjacka - ustawia wartość, kiedy karta jest odsłonięta """
    ACE_VALUE = 1
...
class BJ_Deck(karty.Deck):
    """ Talia kart do blackjacka - ustawia talię do rozdania """
    def populate(self):
...
class BJ_Game(object):
    ...
    def __init__(self, names):      
        ...
        #inicjacja rozdającego
        self.dealer = BJ_Dealer("Rozdający")
        #uzupełnienie talii do gry i tasowanie
        self.deck = BJ_Deck()
        self.deck.populate()
        self.deck.shuffle()

    #gracze pozostali w grze
    @property
